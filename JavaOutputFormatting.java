...
public class Solution {
    ...
    public static void main(String[] args) {
            ...
            for(int i=0;i<3;i++){
               ...
               System.out.printf("%-15s%03d%n",s1,x);
              //% -->formatter 15 -->padding width including string length and 0 -->adding with int 3 -->length of int - --> right padding after string + -->for left padding before string n--> new line
